...
# 误判样本
filename = "f77a58d31931dec288cc7327bfce3ac3bda43f0000ac3b6a61393d4156155f4a.wasm"
wasm_path = str(BENIGN_DIR / filename)
...
# 保存完整结果
output_file = PROJECT_ROOT / "results" / "benign_false_positive_sample.json"
